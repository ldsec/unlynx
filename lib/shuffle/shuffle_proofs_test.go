...
func TestShufflingProof(t *testing.T) {
	...
	PublishedShufflingProof := libunlynxshuffle.ShufflingProofCreation(responses, responsesShuffled, libunlynx.SuiTe.Point().Base(), keys.Public, beta, pi)
	assert.True(t, libunlynxshuffle.ShufflingProofVerification(PublishedShufflingProof, keys.Public))

	PublishedShufflingProof = libunlynxshuffle.ShufflingProofCreation(responses, responses, libunlynx.SuiTe.Point().Base(), keys.Public, beta, pi)
	assert.False(t, libunlynxshuffle.ShufflingProofVerification(PublishedShufflingProof, keys.Public))
}
